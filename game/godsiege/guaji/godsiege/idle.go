...
func init() {
	scene.RegisterGuaJiActionFactory(scenetypes.GuaJiTypeGodSiegeScene, battle.PlayerStateIdle, scene.GuaJiActionFactoryFunc(newIdleAction))
	scene.RegisterGuaJiActionFactory(scenetypes.GuaJiTypeDenseWat, battle.PlayerStateIdle, scene.GuaJiActionFactoryFunc(newIdleAction))
}
