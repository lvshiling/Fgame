...
//玩家在线时间变更
func playerOnlineTimeChanged(target event.EventTarget, data event.EventData) (err error) {
...
func init() {
	gameevent.AddEventListener(playereventtypes.EventTypePlayerOnlineTimeChanged, event.EventListenerFunc(playerOnlineTimeChanged))
}
