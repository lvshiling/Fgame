...
//装备镶嵌宝石
func equipmentEmbedGem(target event.EventTarget, data event.EventData) (err error) {
...
func init() {
	gameevent.AddEventListener(inventoryeventtypes.EventTypeEquipmentEmbedGem, event.EventListenerFunc(equipmentEmbedGem))
}
