...
//装备升阶
func equipmentUpgrade(target event.EventTarget, data event.EventData) (err error) {
...
func init() {
	gameevent.AddEventListener(inventoryeventtypes.EventTypeEquipmentUpgrade, event.EventListenerFunc(equipmentUpgrade))
}
