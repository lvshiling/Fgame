...
func init() {
	guaji.RegisterQuestGuaJi(questtypes.QuestSubTypeKillMonster, guaji.QuestGuaJiFunc(killMonster))
}

func killMonster(p player.Player, questTemplate *gametemplate.QuestTemplate) bool {
