...
func init() {
	quest.RegisterCheck(questtypes.QuestSubTypeActivateYiChuSuitOne, quest.CheckHandlerFunc(handleActivateYiChuSuitOne))
}

//check 处理激活1条属性的衣橱套装X件
func handleActivateYiChuSuitOne(pl player.Player, questTemplate *gametemplate.QuestTemplate) (err error) {
	log.Debug("quest:处理激活1条属性的衣橱套装X件")
