...
func init() {
	quest.RegisterCheck(questtypes.QuestSubTypeClickSoulStrengthenButton, quest.CheckHandlerFunc(handleSoulStrengthenButton))
}

//check 处理帝魂点击事件
func handleSoulStrengthenButton(pl player.Player, questTemplate *gametemplate.QuestTemplate) (err error) {
