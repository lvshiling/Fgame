...
func init() {
	quest.RegisterCheck(questtypes.QuestSubTypeActivateYiChuSuitTwo, quest.CheckHandlerFunc(handleActivateYiChuSuitTwo))
}

//check 处理激活2条属性的衣橱套装X件
func handleActivateYiChuSuitTwo(pl player.Player, questTemplate *gametemplate.QuestTemplate) (err error) {
	log.Debug("quest:处理激活2条属性的衣橱套装X件")
