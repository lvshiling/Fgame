...
func init() {
	quest.RegisterCheck(questtypes.QuestSubTypeApplyJoinAlliance, quest.CheckHandlerFunc(handleQuestApplyJoinAlliance))
}

//check 申请加入仙盟
func handleQuestApplyJoinAlliance(pl player.Player, questTemplate *gametemplate.QuestTemplate) (err error) {
	log.Debug("quest:处理申请加入仙盟")
