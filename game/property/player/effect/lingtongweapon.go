...
func init() {
	playerpropertyproperty.RegisterPlayerPropertyEffector(playerpropertytypes.PlayerPropertyEffectorTypeLingTongWeapon, LingTongWeaponPropertyEffect)
}

//灵兵作用器
func LingTongWeaponPropertyEffect(p player.Player, prop *propertycommon.SystemPropertySegment) {
	...
	//附加系统属性
	additionSysPropertyEffect(p, additionsystypes.AdditionSysTypeLingTongWeapon, prop)
	skillByModulePropertyEffect(p, skilltypes.SkillFirstTypeLingTongWeaponSystemSkill, prop)
}
