...
//充值升阶
func playerChargeAdvancdRew(target event.EventTarget, data event.EventData) (err error) {
...
func init() {
	gameevent.AddEventListener(chargeeventtypes.ChargeEventTypeChargeGold, event.EventListenerFunc(playerChargeAdvancdRew))
}
