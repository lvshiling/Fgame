...
func init() {
	command.Register(gmcommandtypes.CommandTypePlatformTime, command.CommandHandlerFunc(handlePlatformSetTime))
}

func handlePlatformSetTime(pl scene.Player, c *command.Command) (err error) {
