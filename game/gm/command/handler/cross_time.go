...
func init() {
	command.Register(gmcommandtypes.CommandTypeCrossTime, command.CommandHandlerFunc(handleCrossSetTime))
}

func handleCrossSetTime(pl scene.Player, c *command.Command) (err error) {
