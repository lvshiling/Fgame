...
func init() {
	command.Register(gmcommandtypes.CommandTypeGroupTime, command.CommandHandlerFunc(handleGroupSetTime))
}

func handleGroupSetTime(pl scene.Player, c *command.Command) (err error) {
