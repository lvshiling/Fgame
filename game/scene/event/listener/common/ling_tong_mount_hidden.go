...
//坐骑隐藏
func lingTongMountHidden(target event.EventTarget, data event.EventData) (err error) {
...
func init() {
	gameevent.AddEventListener(lingtongeventtypes.EventTypeBattleLingTongShowMountHidden, event.EventListenerFunc(lingTongMountHidden))
}
