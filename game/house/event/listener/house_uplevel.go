...
//玩家房子升级
func playerHouseUplevel(target event.EventTarget, data event.EventData) (err error) {
	...
	operateType := housetypes.HouseOperateTypeUplevel
...
func init() {
	gameevent.AddEventListener(houseventtypes.EventTypeHouseUplevel, event.EventListenerFunc(playerHouseUplevel))
}
