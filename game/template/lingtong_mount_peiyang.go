...
//灵骑培养配置
type LingTongMountPeiYangTemplate struct {
	*LingTongMountPeiYangTemplateVO
...
func (t *LingTongMountPeiYangTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongMountPeiYangTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongMountPeiYangTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongMountPeiYangTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongMountPeiYangTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongMountPeiYangTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongMountPeiYangTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongMountPeiYangTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongMountPeiYangTemplate) GetItemMap() map[int32]int32 {
	return t.useItemMap
}

func (t *LingTongMountPeiYangTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongMountPeiYangTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongMountPeiYangTemplate) GetLevel() int32 {
	return t.Level
}

func (t *LingTongMountPeiYangTemplate) GetNext() LingTongDevPeiYangTemplate {
	return t.next
}

func (t *LingTongMountPeiYangTemplate) GetItemCount() int32 {
	return t.ItemCount
}

func (t *LingTongMountPeiYangTemplate) GetItemId() int32 {
	return t.UseItem
}

func (t *LingTongMountPeiYangTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingQi
}

func (t *LingTongMountPeiYangTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
...
func (t *LingTongMountPeiYangTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.NextId != 0 {
		...
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongMountPeiYangTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.NextId)
			return template.NewTemplateFieldError("NextId", err)
		}

		t.next = to.(*LingTongMountPeiYangTemplate)
	...
	if t.culItemTemplate != nil {
		if t.culItemTemplate.GetItemSubType() != itemtypes.ItemLingTongMountSubTypePeiYangDan {
			err = fmt.Errorf("[%d] invalid", t.UseItem)
...
func (t *LingTongMountPeiYangTemplate) PatchAfterCheck() {

}
func (t *LingTongMountPeiYangTemplate) FileName() string {
	return "tb_lingtong_mount_peiyang.json"
}

func init() {
	template.Register((*LingTongMountPeiYangTemplate)(nil))
}
