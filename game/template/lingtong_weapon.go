...
//灵身配置
type LingTongWeaponTemplate struct {
	*LingTongWeaponTemplateVO
	...
	weaponUpstartTemplateMap  map[int32]LingTongDevUpstarTemplate //灵身皮肤升星map
	weaponUpstartTemplate     LingTongDevUpstarTemplate           //灵身皮肤升星
...
func (t *LingTongWeaponTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongWeaponTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongWeaponTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongWeaponTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongWeaponTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongWeaponTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongWeaponTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongWeaponTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongWeaponTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongWeaponTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongWeaponTemplate) GetType() types.LingTongDevType {
	return t.typ
}

func (t *LingTongWeaponTemplate) GetItemMap() map[int32]int32 {
	return t.itemMap
}

func (t *LingTongWeaponTemplate) GetMagicParamIMap() map[int32]int32 {
	return t.magicParamIMap
}

func (t *LingTongWeaponTemplate) GetMagicParamXUMap() map[int32]int32 {
	return t.magicParamXUMap
}

func (t *LingTongWeaponTemplate) GetIsClear() bool {
	return t.IsClear != 0
}

func (t *LingTongWeaponTemplate) GetUpstarBeginId() int32 {
	return t.LingTongWeaponUpstarBeginId
}

func (t *LingTongWeaponTemplate) GetGold() int64 {
	return t.UseMoney
}

func (t *LingTongWeaponTemplate) GetBindGold() int64 {
	return 0
}

func (t *LingTongWeaponTemplate) GetSilver() int64 {
	return t.UseYinliang
}

func (t *LingTongWeaponTemplate) GetNumber() int32 {
	return t.Number
}

func (t *LingTongWeaponTemplate) GetShiDanLimit() int32 {
	return t.ShidanLimit
}

func (t *LingTongWeaponTemplate) GetCulDanLimit() int32 {
	return 0
}

func (t *LingTongWeaponTemplate) GetNext() LingTongDevTemplate {
	return t.next
}

func (t *LingTongWeaponTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingBing
}

func (t *LingTongWeaponTemplate) GetName() string {
	return t.Name
}

func (t *LingTongWeaponTemplate) GetLingTongDevUpstarByLevel(level int32) LingTongDevUpstarTemplate {
	if v, ok := t.weaponUpstartTemplateMap[level]; ok {
		return v
	}
	return nil
}

func (t *LingTongWeaponTemplate) GetLingTongDevPeiYangByLevel(level int32) LingTongDevPeiYangTemplate {
	return nil
}
func (t *LingTongWeaponTemplate) GetLingTongDevTongLingByLevel(level int32) LingTongDevTongLingTemplate {
	return nil
}

func (t *LingTongWeaponTemplate) PatchAfterCheck() {
	if t.weaponUpstartTemplate != nil {
		t.weaponUpstartTemplateMap = make(map[int32]LingTongDevUpstarTemplate)
		//赋值weaponUpstartTemplateMap
		for tempTemplate := t.weaponUpstartTemplate; tempTemplate != nil; tempTemplate = tempTemplate.GetNext() {
			level := tempTemplate.GetLevel()
			t.weaponUpstartTemplateMap[level] = tempTemplate
		}
	}
}

func (t *LingTongWeaponTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
	...
	if t.LingTongWeaponUpstarBeginId != 0 {
		to := template.GetTemplateService().Get(int(t.LingTongWeaponUpstarBeginId), (*LingTongWeaponUpstarTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.LingTongWeaponUpstarBeginId)
			return template.NewTemplateFieldError("LingTongWeaponUpstarBeginId", err)
		}

		weaponUpstartTemplate, ok := to.(*LingTongWeaponUpstarTemplate)
		if !ok {
			return fmt.Errorf("LingTongWeaponUpgradeBeginId [%d] invalid", t.LingTongWeaponUpstarBeginId)
		}

		t.weaponUpstartTemplate = weaponUpstartTemplate
	}
...
func (t *LingTongWeaponTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.NextId != 0 {
		...
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongWeaponTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.NextId)
			return template.NewTemplateFieldError("NextId", err)
		}

		t.next = to.(*LingTongWeaponTemplate)
	}
...
func (t *LingTongWeaponTemplate) FileName() string {
	return "tb_lingtong_weapon.json"
}

func init() {
	template.Register((*LingTongWeaponTemplate)(nil))
}
