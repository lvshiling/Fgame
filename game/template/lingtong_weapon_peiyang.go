...
//灵兵培养配置
type LingTongWeaponPeiYangTemplate struct {
	*LingTongWeaponPeiYangTemplateVO
...
func (t *LingTongWeaponPeiYangTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongWeaponPeiYangTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongWeaponPeiYangTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongWeaponPeiYangTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongWeaponPeiYangTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongWeaponPeiYangTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongWeaponPeiYangTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongWeaponPeiYangTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongWeaponPeiYangTemplate) GetItemMap() map[int32]int32 {
	return t.useItemMap
}

func (t *LingTongWeaponPeiYangTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongWeaponPeiYangTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongWeaponPeiYangTemplate) GetLevel() int32 {
	return t.Level
}

func (t *LingTongWeaponPeiYangTemplate) GetNext() LingTongDevPeiYangTemplate {
	return t.next
}

func (t *LingTongWeaponPeiYangTemplate) GetItemCount() int32 {
	return t.ItemCount
}

func (t *LingTongWeaponPeiYangTemplate) GetItemId() int32 {
	return t.UseItem
}

func (t *LingTongWeaponPeiYangTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingQi
}

func (t *LingTongWeaponPeiYangTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
...
func (t *LingTongWeaponPeiYangTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.NextId != 0 {
		...
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongWeaponPeiYangTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.NextId)
			return template.NewTemplateFieldError("NextId", err)
		}

		t.next = to.(*LingTongWeaponPeiYangTemplate)
	...
	if t.culItemTemplate != nil {
		if t.culItemTemplate.GetItemSubType() != itemtypes.ItemLingTongWeaponSubTypePeiYangDan {
			err = fmt.Errorf("[%d] invalid", t.UseItem)
...
func (t *LingTongWeaponPeiYangTemplate) PatchAfterCheck() {

}
func (t *LingTongWeaponPeiYangTemplate) FileName() string {
	return "tb_lingtong_weapon_peiyang.json"
}

func init() {
	template.Register((*LingTongWeaponPeiYangTemplate)(nil))
}
