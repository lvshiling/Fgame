...
//灵宝培养配置
type LingTongFaBaoPeiYangTemplate struct {
	*LingTongFaBaoPeiYangTemplateVO
...
func (t *LingTongFaBaoPeiYangTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongFaBaoPeiYangTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongFaBaoPeiYangTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongFaBaoPeiYangTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongFaBaoPeiYangTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongFaBaoPeiYangTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongFaBaoPeiYangTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongFaBaoPeiYangTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongFaBaoPeiYangTemplate) GetItemMap() map[int32]int32 {
	return t.useItemMap
}

func (t *LingTongFaBaoPeiYangTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongFaBaoPeiYangTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongFaBaoPeiYangTemplate) GetLevel() int32 {
	return t.Level
}

func (t *LingTongFaBaoPeiYangTemplate) GetNext() LingTongDevPeiYangTemplate {
	return t.next
}

func (t *LingTongFaBaoPeiYangTemplate) GetItemCount() int32 {
	return t.ItemCount
}

func (t *LingTongFaBaoPeiYangTemplate) GetItemId() int32 {
	return t.UseItem
}

func (t *LingTongFaBaoPeiYangTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingQi
}

func (t *LingTongFaBaoPeiYangTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
...
func (t *LingTongFaBaoPeiYangTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.NextId != 0 {
		...
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongFaBaoPeiYangTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.NextId)
			return template.NewTemplateFieldError("NextId", err)
		}

		t.next = to.(*LingTongFaBaoPeiYangTemplate)
	...
	if t.culItemTemplate != nil {
		if t.culItemTemplate.GetItemSubType() != itemtypes.ItemLingTongFaBaoSubTypePeiYangDan {
			err = fmt.Errorf("[%d] invalid", t.UseItem)
...
func (t *LingTongFaBaoPeiYangTemplate) PatchAfterCheck() {

}
func (t *LingTongFaBaoPeiYangTemplate) FileName() string {
	return "tb_lingtong_fabao_peiyang.json"
}

func init() {
	template.Register((*LingTongFaBaoPeiYangTemplate)(nil))
}
