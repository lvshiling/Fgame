...
//灵翼幻化配置
type LingTongWingHuanHuaTemplate struct {
	*LingTongWingHuanHuaTemplateVO
...
func (t *LingTongWingHuanHuaTemplate) TemplateId() int {
	return t.Id
}
func (t *LingTongWingHuanHuaTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongWingHuanHuaTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongWingHuanHuaTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongWingHuanHuaTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongWingHuanHuaTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongWingHuanHuaTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongWingHuanHuaTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongWingHuanHuaTemplate) GetItemMap() map[int32]int32 {
	return t.useItemMap
}

func (t *LingTongWingHuanHuaTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongWingHuanHuaTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongWingHuanHuaTemplate) GetLevel() int32 {
	return t.Level
}

func (t *LingTongWingHuanHuaTemplate) GetNext() LingTongDevHuanHuaTemplate {
	return t.next
}

func (t *LingTongWingHuanHuaTemplate) GetItemCount() int32 {
	return t.ItemCount
}

func (t *LingTongWingHuanHuaTemplate) GetItemId() int32 {
	return t.UseItem
}

func (t *LingTongWingHuanHuaTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingYi
}

func (t *LingTongWingHuanHuaTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
...
func (t *LingTongWingHuanHuaTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.NextId != 0 {
		...
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongWingHuanHuaTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.NextId)
			return template.NewTemplateFieldError("NextId", err)
		}

		huanHuaTemplate := to.(*LingTongWingHuanHuaTemplate)
	...
	if t.unrealItemTemplate != nil {
		if t.unrealItemTemplate.GetItemSubType() != itemtypes.ItemLingTongWingSubTypeUnrealDan {
			err = fmt.Errorf("[%d] invalid", t.UseItem)
...
func (t *LingTongWingHuanHuaTemplate) PatchAfterCheck() {

}
func (t *LingTongWingHuanHuaTemplate) FileName() string {
	return "tb_lingtong_wing_huanhua.json"
}

func init() {
	template.Register((*LingTongWingHuanHuaTemplate)(nil))
}
