...
//配置
type ChuangShiWarGuardTemplate struct {
	*ChuangShiWarGuardTemplateVO
	mapTemplate *MapTemplate
	itemMap     map[int32]int32
}

func (t *ChuangShiWarGuardTemplate) TemplateId() int {
	return t.Id
}

func (t *ChuangShiWarGuardTemplate) GetItemMap() map[int32]int32 {
	return t.itemMap
}

func (t *ChuangShiWarGuardTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
...
func (t *ChuangShiWarGuardTemplate) PatchAfterCheck() {

}

func (t *ChuangShiWarGuardTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
...
func (tt *ChuangShiWarGuardTemplate) FileName() string {
	return "tb_chuangshi_war_guard.json"
}

func init() {
	template.Register((*ChuangShiWarGuardTemplate)(nil))
}
