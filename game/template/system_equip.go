...
//装备配置
type SystemEquipTemplate struct {
	*SystemEquipTemplateVO
	// //一级强化模板
...
func (t *SystemEquipTemplate) TemplateId() int {
	return t.Id
}

func (t *SystemEquipTemplate) GetTaozhuangTemplate() *SystemTaozhuangTemplate {
	return t.tempTaozhuangTemplate
}

func (t *SystemEquipTemplate) GetNeedItemMap() map[int32]int32 {
	return t.needItemMap
}

func (t *SystemEquipTemplate) GetReturnItemMap() map[int32]int32 {
	return t.returnItemMap
}

func (t *SystemEquipTemplate) HasCondition() bool {
	return len(t.needItemMap) != 0
}

func (t *SystemEquipTemplate) GetNextItemTemplate() *ItemTemplate {
	return t.nextItemTemplate
}

// func (t *SystemEquipTemplate) GetStrengthenTemplate(level int32) *SystemStrengthenTemplate {
// 	return t.strengthenTemplateMap[level]
// }

func (t *SystemEquipTemplate) GetTushiExp() int32 {
	return t.TushiExp
}

func (t *SystemEquipTemplate) GetHp() int32 {
	return t.Hp
}

func (t *SystemEquipTemplate) GetAttack() int32 {
	return t.Attack
}

func (t *SystemEquipTemplate) GetDefence() int32 {
	return t.Defence
}

func (t *SystemEquipTemplate) GetSuccessRate() int32 {
	return t.SuccessRate
}

func (t *SystemEquipTemplate) GetBattleProperty() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *SystemEquipTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
...
func (t *SystemEquipTemplate) PatchAfterCheck() {
	// //动态强化模板
...
func (t *SystemEquipTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
...
func (edt *SystemEquipTemplate) FileName() string {
	return "tb_system_equip.json"
}

func init() {
	template.Register((*SystemEquipTemplate)(nil))
}
