...
//灵体幻化配置
type LingTongXianTiHuanHuaTemplate struct {
	*LingTongXianTiHuanHuaTemplateVO
...
func (t *LingTongXianTiHuanHuaTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongXianTiHuanHuaTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongXianTiHuanHuaTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongXianTiHuanHuaTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongXianTiHuanHuaTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongXianTiHuanHuaTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongXianTiHuanHuaTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongXianTiHuanHuaTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongXianTiHuanHuaTemplate) GetItemMap() map[int32]int32 {
	return t.useItemMap
}

func (t *LingTongXianTiHuanHuaTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongXianTiHuanHuaTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongXianTiHuanHuaTemplate) GetLevel() int32 {
	return t.Level
}

func (t *LingTongXianTiHuanHuaTemplate) GetNext() LingTongDevHuanHuaTemplate {
	return t.next
}

func (t *LingTongXianTiHuanHuaTemplate) GetItemCount() int32 {
	return t.ItemCount
}

func (t *LingTongXianTiHuanHuaTemplate) GetItemId() int32 {
	return t.UseItem
}

func (t *LingTongXianTiHuanHuaTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingTi
}

func (t *LingTongXianTiHuanHuaTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
...
func (t *LingTongXianTiHuanHuaTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.NextId != 0 {
		...
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongXianTiHuanHuaTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.NextId)
			return template.NewTemplateFieldError("NextId", err)
		}

		huanHuaTemplate := to.(*LingTongXianTiHuanHuaTemplate)
	...
	if t.unrealItemTemplate != nil {
		if t.unrealItemTemplate.GetItemSubType() != itemtypes.ItemLingTongXianTiSubTypeUnrealDan {
			err = fmt.Errorf("[%d] invalid", t.UseItem)
...
func (t *LingTongXianTiHuanHuaTemplate) PatchAfterCheck() {

}
func (t *LingTongXianTiHuanHuaTemplate) FileName() string {
	return "tb_lingtong_xianti_huanhua.json"
}

func init() {
	template.Register((*LingTongXianTiHuanHuaTemplate)(nil))
}
