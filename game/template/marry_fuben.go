...
//夫妻配置
type MarryFuBenTemplate struct {
	*MarryFuBenTemplateVO
...
func (t *MarryFuBenTemplate) TemplateId() int {
	return t.Id
}

func (t *MarryFuBenTemplate) GetMapId() int32 {
	return t.MapId
}

func (t *MarryFuBenTemplate) GetBossId() int32 {
	return t.BossId
}

func (t *MarryFuBenTemplate) GetRewItemMap() map[int32]int32 {
	return t.rewItemMap
}

func (t *MarryFuBenTemplate) GetMajorType() majortypes.MajorType {
	return majortypes.MajorTypeFuQi
}

func (t *MarryFuBenTemplate) GetSaodangNeedGold() int32 {
	return t.SaodangNeedGold
}

func (t *MarryFuBenTemplate) GetRawSilver() int64 {
	return t.RawSilver
}

func (t *MarryFuBenTemplate) GetRawBindGold() int32 {
	return t.RawBindGold
}

func (t *MarryFuBenTemplate) GetRawGold() int32 {
	return t.RawGold
}

func (t *MarryFuBenTemplate) GetRawExp() int64 {
	return t.RawExp
}

func (t *MarryFuBenTemplate) GetRawExpPoint() int64 {
	return t.RawExpPoint
}

//获取扫荡所需物品
func (t *MarryFuBenTemplate) GetSaodangItemMap(saoDangNum int32) map[int32]int32 {
...
//获取扫荡奖励物品
func (t *MarryFuBenTemplate) GetSaodangRewardItemMap(saoDangNum int32) map[int32]int32 {
	newMap := make(map[int32]int32)
	if saoDangNum < 1 {
		return nil
	}
...
//获取扫荡掉落物品
func (t *MarryFuBenTemplate) GetSaodangRewardDropArr() []int32 {
	return t.saodangRewardDropArr
}

func (t *MarryFuBenTemplate) PatchAfterCheck() {
}

func (t *MarryFuBenTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
...
func (t *MarryFuBenTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.mapTemplate.GetMapType() != scenetypes.SceneTypeFuQiFuBen {
		err = fmt.Errorf("[%d] invalid", t.MapId)
		err = template.NewTemplateFieldError("MapId", err)
		return
	}
...
func (t *MarryFuBenTemplate) FileName() string {
	return "tb_xianfu_fuqi.json"
}

func init() {
	template.Register((*MarryFuBenTemplate)(nil))
}
