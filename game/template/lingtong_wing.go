...
//灵翼配置
type LingTongWingTemplate struct {
	*LingTongWingTemplateVO
	typ                       types.LingTongDevType               //灵翼类型
	...
	wingUpstartTemplateMap    map[int32]LingTongDevUpstarTemplate //灵翼皮肤升星map
	wingUpstartTemplate       LingTongDevUpstarTemplate           //灵翼皮肤升星
...
func (t *LingTongWingTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongWingTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongWingTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongWingTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongWingTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongWingTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongWingTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongWingTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongWingTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongWingTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongWingTemplate) GetType() types.LingTongDevType {
	return t.typ
}

func (t *LingTongWingTemplate) GetItemMap() map[int32]int32 {
	return t.itemMap
}

func (t *LingTongWingTemplate) GetMagicParamIMap() map[int32]int32 {
	return t.magicParamIMap
}

func (t *LingTongWingTemplate) GetMagicParamXUMap() map[int32]int32 {
	return t.magicParamXUMap
}

func (t *LingTongWingTemplate) GetIsClear() bool {
	return t.IsClear != 0
}

func (t *LingTongWingTemplate) GetUpstarBeginId() int32 {
	return t.LingTongWingUpstarBeginId
}

func (t *LingTongWingTemplate) GetGold() int64 {
	return t.UseMoney
}

func (t *LingTongWingTemplate) GetBindGold() int64 {
	return 0
}

func (t *LingTongWingTemplate) GetSilver() int64 {
	return t.UseYinliang
}

func (t *LingTongWingTemplate) GetNumber() int32 {
	return t.Number
}

func (t *LingTongWingTemplate) GetShiDanLimit() int32 {
	return t.ShidanLimit
}

func (t *LingTongWingTemplate) GetCulDanLimit() int32 {
	return 0
}

func (t *LingTongWingTemplate) GetNext() LingTongDevTemplate {
	return t.next
}

func (t *LingTongWingTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingYi
}

func (t *LingTongWingTemplate) GetName() string {
	return t.Name
}

func (t *LingTongWingTemplate) GetLingTongDevUpstarByLevel(level int32) LingTongDevUpstarTemplate {
	if v, ok := t.wingUpstartTemplateMap[level]; ok {
		return v
	}
	return nil
}

func (t *LingTongWingTemplate) GetLingTongDevPeiYangByLevel(level int32) LingTongDevPeiYangTemplate {
	return nil
}
func (t *LingTongWingTemplate) GetLingTongDevTongLingByLevel(level int32) LingTongDevTongLingTemplate {
	return nil
}

func (t *LingTongWingTemplate) PatchAfterCheck() {
	if t.wingUpstartTemplate != nil {
		t.wingUpstartTemplateMap = make(map[int32]LingTongDevUpstarTemplate)
		//赋值wingUpstartTemplateMap
		for tempTemplate := t.wingUpstartTemplate; tempTemplate != nil; tempTemplate = tempTemplate.GetNext() {
			level := tempTemplate.GetLevel()
			t.wingUpstartTemplateMap[level] = tempTemplate
		}
	}
}

func (t *LingTongWingTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
	...
	if t.LingTongWingUpstarBeginId != 0 {
		to := template.GetTemplateService().Get(int(t.LingTongWingUpstarBeginId), (*LingTongWingUpstarTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.LingTongWingUpstarBeginId)
			return template.NewTemplateFieldError("LingTongWingUpstarBeginId", err)
		}

		wingUpstartTemplate, ok := to.(*LingTongWingUpstarTemplate)
		if !ok {
			return fmt.Errorf("LingTongWingUpgradeBeginId [%d] invalid", t.LingTongWingUpstarBeginId)
		}

		t.wingUpstartTemplate = wingUpstartTemplate
	}
...
func (t *LingTongWingTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.NextId != 0 {
		...
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongWingTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.NextId)
			return template.NewTemplateFieldError("NextId", err)
		}

		t.next = to.(*LingTongWingTemplate)
	}
...
func (t *LingTongWingTemplate) FileName() string {
	return "tb_lingtong_wing.json"
}

func init() {
	template.Register((*LingTongWingTemplate)(nil))
}
