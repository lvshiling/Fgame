...
//灵骑幻化配置
type LingTongMountHuanHuaTemplate struct {
	*LingTongMountHuanHuaTemplateVO
...
func (t *LingTongMountHuanHuaTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongMountHuanHuaTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongMountHuanHuaTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongMountHuanHuaTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongMountHuanHuaTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongMountHuanHuaTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongMountHuanHuaTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongMountHuanHuaTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongMountHuanHuaTemplate) GetItemMap() map[int32]int32 {
	return t.useItemMap
}

func (t *LingTongMountHuanHuaTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongMountHuanHuaTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongMountHuanHuaTemplate) GetLevel() int32 {
	return t.Level
}

func (t *LingTongMountHuanHuaTemplate) GetNext() LingTongDevHuanHuaTemplate {
	return t.next
}

func (t *LingTongMountHuanHuaTemplate) GetItemCount() int32 {
	return t.ItemCount
}

func (t *LingTongMountHuanHuaTemplate) GetItemId() int32 {
	return t.UseItem
}

func (t *LingTongMountHuanHuaTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingQi
}

func (t *LingTongMountHuanHuaTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
...
func (t *LingTongMountHuanHuaTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.NextId != 0 {
		...
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongMountHuanHuaTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.NextId)
			return template.NewTemplateFieldError("NextId", err)
		}

		huanHuaTemplate := to.(*LingTongMountHuanHuaTemplate)
	...
	if t.unrealItemTemplate != nil {
		if t.unrealItemTemplate.GetItemSubType() != itemtypes.ItemLingTongMountSubTypeUnrealDan {
			err = fmt.Errorf("[%d] invalid", t.UseItem)
...
func (t *LingTongMountHuanHuaTemplate) PatchAfterCheck() {

}
func (t *LingTongMountHuanHuaTemplate) FileName() string {
	return "tb_lingtong_mount_huanhua.json"
}

func init() {
	template.Register((*LingTongMountHuanHuaTemplate)(nil))
}
