...
//灵域升星配置
type LingTongLingYuUpstarTemplate struct {
	*LingTongLingYuUpstarTemplateVO
...
func (t *LingTongLingYuUpstarTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongLingYuUpstarTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongLingYuUpstarTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongLingYuUpstarTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongLingYuUpstarTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongLingYuUpstarTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongLingYuUpstarTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongLingYuUpstarTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongLingYuUpstarTemplate) GetItemMap() map[int32]int32 {
	return t.needItemMap
}

func (t *LingTongLingYuUpstarTemplate) GetUpstarPercent() int32 {
	return t.Percent
}

func (t *LingTongLingYuUpstarTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongLingYuUpstarTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongLingYuUpstarTemplate) GetLevel() int32 {
	return t.Level
}

func (t *LingTongLingYuUpstarTemplate) GetNext() LingTongDevUpstarTemplate {
	return t.next
}

func (t *LingTongLingYuUpstarTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingYu
}

func (t *LingTongLingYuUpstarTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
	...
	//验证 next_id
	if t.NextId != 0 {
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongLingYuUpstarTemplate)(nil))
		if to != nil {
			nextTemplate := to.(*LingTongLingYuUpstarTemplate)
...
func (t *LingTongLingYuUpstarTemplate) PatchAfterCheck() {

}

func (t *LingTongLingYuUpstarTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	for itemId, _ := range t.needItemMap {
		...
		if itemTemplate.GetItemType() != itemtypes.ItemTypeLingTongLingYu {
...
func (t *LingTongLingYuUpstarTemplate) FileName() string {
	return "tb_lingtong_field_upstar.json"
}

func init() {
	template.Register((*LingTongLingYuUpstarTemplate)(nil))
}
