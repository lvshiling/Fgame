...
//灵宝配置
type LingTongFaBaoTemplate struct {
	*LingTongFaBaoTemplateVO
	typ                       types.LingTongDevType               //灵宝类型
	...
	faBaoUpstartTemplateMap   map[int32]LingTongDevUpstarTemplate //灵宝皮肤升星map
	faBaoUpstartTemplate      LingTongDevUpstarTemplate           //灵宝皮肤升星
...
func (t *LingTongFaBaoTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongFaBaoTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongFaBaoTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongFaBaoTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongFaBaoTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongFaBaoTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongFaBaoTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongFaBaoTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongFaBaoTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongFaBaoTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongFaBaoTemplate) GetType() types.LingTongDevType {
	return t.typ
}

func (t *LingTongFaBaoTemplate) GetItemMap() map[int32]int32 {
	return t.itemMap
}

func (t *LingTongFaBaoTemplate) GetMagicParamIMap() map[int32]int32 {
	return t.magicParamIMap
}

func (t *LingTongFaBaoTemplate) GetMagicParamXUMap() map[int32]int32 {
	return t.magicParamXUMap
}

func (t *LingTongFaBaoTemplate) GetIsClear() bool {
	return t.IsClear != 0
}

func (t *LingTongFaBaoTemplate) GetUpstarBeginId() int32 {
	return t.LingTongFaBaoUpstarBeginId
}

func (t *LingTongFaBaoTemplate) GetGold() int64 {
	return t.UseMoney
}

func (t *LingTongFaBaoTemplate) GetBindGold() int64 {
	return 0
}

func (t *LingTongFaBaoTemplate) GetSilver() int64 {
	return t.UseYinliang
}

func (t *LingTongFaBaoTemplate) GetNumber() int32 {
	return t.Number
}

func (t *LingTongFaBaoTemplate) GetShiDanLimit() int32 {
	return t.ShidanLimit
}

func (t *LingTongFaBaoTemplate) GetCulDanLimit() int32 {
	return 0
}

func (t *LingTongFaBaoTemplate) GetNext() LingTongDevTemplate {
	return t.next
}

func (t *LingTongFaBaoTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingBao
}

func (t *LingTongFaBaoTemplate) GetName() string {
	return t.Name
}

func (t *LingTongFaBaoTemplate) GetLingTongDevUpstarByLevel(level int32) LingTongDevUpstarTemplate {
	if v, ok := t.faBaoUpstartTemplateMap[level]; ok {
		return v
	}
	return nil
}

func (t *LingTongFaBaoTemplate) GetLingTongDevPeiYangByLevel(level int32) LingTongDevPeiYangTemplate {
	return nil
}
func (t *LingTongFaBaoTemplate) GetLingTongDevTongLingByLevel(level int32) LingTongDevTongLingTemplate {
	return nil
}

func (t *LingTongFaBaoTemplate) PatchAfterCheck() {
	if t.faBaoUpstartTemplate != nil {
		t.faBaoUpstartTemplateMap = make(map[int32]LingTongDevUpstarTemplate)
		//赋值faBaoUpstartTemplateMap
		for tempTemplate := t.faBaoUpstartTemplate; tempTemplate != nil; tempTemplate = tempTemplate.GetNext() {
			level := tempTemplate.GetLevel()
			t.faBaoUpstartTemplateMap[level] = tempTemplate
		}
	}
}

func (t *LingTongFaBaoTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
	...
	if t.LingTongFaBaoUpstarBeginId != 0 {
		to := template.GetTemplateService().Get(int(t.LingTongFaBaoUpstarBeginId), (*LingTongFaBaoUpstarTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.LingTongFaBaoUpstarBeginId)
			return template.NewTemplateFieldError("LingTongFaBaoUpstarBeginId", err)
		}

		faBaoUpstartTemplate, ok := to.(*LingTongFaBaoUpstarTemplate)
		if !ok {
			return fmt.Errorf("LingTongFaBaoUpgradeBeginId [%d] invalid", t.LingTongFaBaoUpstarBeginId)
		}

		t.faBaoUpstartTemplate = faBaoUpstartTemplate
	}
...
func (t *LingTongFaBaoTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.NextId != 0 {
		...
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongFaBaoTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.NextId)
			return template.NewTemplateFieldError("NextId", err)
		}
		t.next = to.(*LingTongFaBaoTemplate)
	}
...
func (t *LingTongFaBaoTemplate) FileName() string {
	return "tb_lingtong_fabao.json"
}

func init() {
	template.Register((*LingTongFaBaoTemplate)(nil))
}
