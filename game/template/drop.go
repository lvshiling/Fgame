...
func (t *DropTemplate) TemplateId() int {
	return t.Id
}

func (t *DropTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
...
func (t *DropTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
...
func (t *DropTemplate) PatchAfterCheck() {
	// 金装随机升星等级
...
func (t *DropTemplate) RandomNum() int32 {
	minCount := t.MinCount
...
func (t *DropTemplate) RandomGoldEquipLevel() int32 {
	minCount := t.GoldEquipMin
	maxCount := t.GoldEquipMax + 1
	count := mathutils.RandomRange(int(minCount), int(maxCount))
	return int32(count)
}

func (t *DropTemplate) RandomGoldEquipUpstarLevel() int32 {
...
func (t *DropTemplate) RandomGoldEquipAttr() (attrList []int32, isRandom bool) {
...
func (t *DropTemplate) RandomStack() int32 {
	minStack := t.MinStack
	maxStack := t.MaxStack + 1
	stack := mathutils.RandomRange(int(minStack), int(maxStack))
	return int32(stack)
}

func (t *DropTemplate) GetBindType() itemtypes.ItemBindType {
	return t.bindType
}

func (t *DropTemplate) FileName() string {
	return "tb_drop.json"
}

func init() {
	template.Register((*DropTemplate)(nil))
}
