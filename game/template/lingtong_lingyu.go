...
//灵域配置
type LingTongLingYuTemplate struct {
	*LingTongLingYuTemplateVO
	typ                       types.LingTongDevType               //灵域类型
	...
	lingYuUpstartTemplateMap  map[int32]LingTongDevUpstarTemplate //灵域皮肤升星map
	lingYuUpstartTemplate     LingTongDevUpstarTemplate           //灵域皮肤升星
...
func (t *LingTongLingYuTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongLingYuTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongLingYuTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongLingYuTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongLingYuTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongLingYuTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongLingYuTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongLingYuTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongLingYuTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongLingYuTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongLingYuTemplate) GetType() types.LingTongDevType {
	return t.typ
}

func (t *LingTongLingYuTemplate) GetItemMap() map[int32]int32 {
	return t.itemMap
}

func (t *LingTongLingYuTemplate) GetMagicParamIMap() map[int32]int32 {
	return t.magicParamIMap
}

func (t *LingTongLingYuTemplate) GetMagicParamXUMap() map[int32]int32 {
	return t.magicParamXUMap
}

func (t *LingTongLingYuTemplate) GetIsClear() bool {
	return t.IsClear != 0
}

func (t *LingTongLingYuTemplate) GetUpstarBeginId() int32 {
	return t.LingTongFieldUpstarBeginId
}

func (t *LingTongLingYuTemplate) GetGold() int64 {
	return t.UseMoney
}

func (t *LingTongLingYuTemplate) GetBindGold() int64 {
	return 0
}

func (t *LingTongLingYuTemplate) GetSilver() int64 {
	return t.UseYinliang
}

func (t *LingTongLingYuTemplate) GetNumber() int32 {
	return t.Number
}

func (t *LingTongLingYuTemplate) GetShiDanLimit() int32 {
	return t.ShidanLimit
}

func (t *LingTongLingYuTemplate) GetCulDanLimit() int32 {
	return 0
}

func (t *LingTongLingYuTemplate) GetNext() LingTongDevTemplate {
	return t.next
}

func (t *LingTongLingYuTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingYu
}

func (t *LingTongLingYuTemplate) GetName() string {
	return t.Name
}

func (t *LingTongLingYuTemplate) GetLingTongDevUpstarByLevel(level int32) LingTongDevUpstarTemplate {
	if v, ok := t.lingYuUpstartTemplateMap[level]; ok {
		return v
	}
	return nil
}

func (t *LingTongLingYuTemplate) GetLingTongDevPeiYangByLevel(level int32) LingTongDevPeiYangTemplate {
	return nil
}
func (t *LingTongLingYuTemplate) GetLingTongDevTongLingByLevel(level int32) LingTongDevTongLingTemplate {
	return nil
}

func (t *LingTongLingYuTemplate) PatchAfterCheck() {
	if t.lingYuUpstartTemplate != nil {
		t.lingYuUpstartTemplateMap = make(map[int32]LingTongDevUpstarTemplate)
		//赋值lingYuUpstartTemplateMap
		for tempTemplate := t.lingYuUpstartTemplate; tempTemplate != nil; tempTemplate = tempTemplate.GetNext() {
			level := tempTemplate.GetLevel()
			t.lingYuUpstartTemplateMap[level] = tempTemplate
		}
	}
}

func (t *LingTongLingYuTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
	...
	if t.LingTongFieldUpstarBeginId != 0 {
		to := template.GetTemplateService().Get(int(t.LingTongFieldUpstarBeginId), (*LingTongLingYuUpstarTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.LingTongFieldUpstarBeginId)
			return template.NewTemplateFieldError("LingTongFieldUpstarBeginId", err)
		}

		lingYuUpstartTemplate, ok := to.(*LingTongLingYuUpstarTemplate)
		if !ok {
			return fmt.Errorf("LingTongLingYuUpgradeBeginId [%d] invalid", t.LingTongFieldUpstarBeginId)
		}

		t.lingYuUpstartTemplate = lingYuUpstartTemplate
	}
...
func (t *LingTongLingYuTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.NextId != 0 {
		...
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongLingYuTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.NextId)
			return template.NewTemplateFieldError("NextId", err)
		}

		t.next = to.(*LingTongLingYuTemplate)
	}
...
func (t *LingTongLingYuTemplate) FileName() string {
	return "tb_lingtong_field.json"
}

func init() {
	template.Register((*LingTongLingYuTemplate)(nil))
}
