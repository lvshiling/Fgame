...
//灵体升星配置
type LingTongXianTiUpstarTemplate struct {
	*LingTongXianTiUpstarTemplateVO
...
func (t *LingTongXianTiUpstarTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongXianTiUpstarTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongXianTiUpstarTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongXianTiUpstarTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongXianTiUpstarTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongXianTiUpstarTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongXianTiUpstarTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongXianTiUpstarTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongXianTiUpstarTemplate) GetItemMap() map[int32]int32 {
	return t.needItemMap
}

func (t *LingTongXianTiUpstarTemplate) GetUpstarPercent() int32 {
	return t.Percent
}

func (t *LingTongXianTiUpstarTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongXianTiUpstarTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongXianTiUpstarTemplate) GetLevel() int32 {
	return t.Level
}

func (t *LingTongXianTiUpstarTemplate) GetNext() LingTongDevUpstarTemplate {
	return t.next
}

func (t *LingTongXianTiUpstarTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingTi
}

func (t *LingTongXianTiUpstarTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
	...
	//验证 next_id
	if t.NextId != 0 {
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongXianTiUpstarTemplate)(nil))
		if to != nil {
			nextTemplate := to.(*LingTongXianTiUpstarTemplate)
...
func (t *LingTongXianTiUpstarTemplate) PatchAfterCheck() {

}

func (t *LingTongXianTiUpstarTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	for itemId, _ := range t.needItemMap {
		...
		if itemTemplate.GetItemType() != itemtypes.ItemTypeLingTongXianTi {
...
func (t *LingTongXianTiUpstarTemplate) FileName() string {
	return "tb_lingtong_xianti_upstar.json"
}

func init() {
	template.Register((*LingTongXianTiUpstarTemplate)(nil))
}
