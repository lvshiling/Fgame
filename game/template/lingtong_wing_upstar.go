...
//灵翼升星配置
type LingTongWingUpstarTemplate struct {
	*LingTongWingUpstarTemplateVO
...
func (t *LingTongWingUpstarTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongWingUpstarTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongWingUpstarTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongWingUpstarTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongWingUpstarTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongWingUpstarTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongWingUpstarTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongWingUpstarTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongWingUpstarTemplate) GetItemMap() map[int32]int32 {
	return t.needItemMap
}

func (t *LingTongWingUpstarTemplate) GetUpstarPercent() int32 {
	return t.Percent
}

func (t *LingTongWingUpstarTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongWingUpstarTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongWingUpstarTemplate) GetLevel() int32 {
	return t.Level
}

func (t *LingTongWingUpstarTemplate) GetNext() LingTongDevUpstarTemplate {
	return t.next
}

func (t *LingTongWingUpstarTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingYi
}

func (t *LingTongWingUpstarTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
	...
	//验证 next_id
	if t.NextId != 0 {
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongWingUpstarTemplate)(nil))
		if to != nil {
			nextTemplate := to.(*LingTongWingUpstarTemplate)
...
func (t *LingTongWingUpstarTemplate) PatchAfterCheck() {

}

func (t *LingTongWingUpstarTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	for itemId, _ := range t.needItemMap {
		...
		if itemTemplate.GetItemType() != itemtypes.ItemTypeLingTongWing {
...
func (t *LingTongWingUpstarTemplate) FileName() string {
	return "tb_lingtong_wing_upstar.json"
}

func init() {
	template.Register((*LingTongWingUpstarTemplate)(nil))
}
