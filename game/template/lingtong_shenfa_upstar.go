...
//灵身升星配置
type LingTongShenFaUpstarTemplate struct {
	*LingTongShenFaUpstarTemplateVO
...
func (t *LingTongShenFaUpstarTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongShenFaUpstarTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongShenFaUpstarTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongShenFaUpstarTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongShenFaUpstarTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongShenFaUpstarTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongShenFaUpstarTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongShenFaUpstarTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongShenFaUpstarTemplate) GetItemMap() map[int32]int32 {
	return t.needItemMap
}

func (t *LingTongShenFaUpstarTemplate) GetUpstarPercent() int32 {
	return t.Percent
}

func (t *LingTongShenFaUpstarTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongShenFaUpstarTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongShenFaUpstarTemplate) GetLevel() int32 {
	return t.Level
}

func (t *LingTongShenFaUpstarTemplate) GetNext() LingTongDevUpstarTemplate {
	return t.next
}

func (t *LingTongShenFaUpstarTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingShen
}

func (t *LingTongShenFaUpstarTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
	...
	//验证 next_id
	if t.NextId != 0 {
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongShenFaUpstarTemplate)(nil))
		if to != nil {
			nextTemplate := to.(*LingTongShenFaUpstarTemplate)
...
func (t *LingTongShenFaUpstarTemplate) PatchAfterCheck() {

}

func (t *LingTongShenFaUpstarTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	for itemId, _ := range t.needItemMap {
		...
		if itemTemplate.GetItemType() != itemtypes.ItemTypeLingTongShenFa {
...
func (t *LingTongShenFaUpstarTemplate) FileName() string {
	return "tb_lingtong_shenfa_upstar.json"
}

func init() {
	template.Register((*LingTongShenFaUpstarTemplate)(nil))
}
