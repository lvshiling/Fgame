...
//灵域培养配置
type LingTongLingYuPeiYangTemplate struct {
	*LingTongLingYuPeiYangTemplateVO
...
func (t *LingTongLingYuPeiYangTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongLingYuPeiYangTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongLingYuPeiYangTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongLingYuPeiYangTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongLingYuPeiYangTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongLingYuPeiYangTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongLingYuPeiYangTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongLingYuPeiYangTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongLingYuPeiYangTemplate) GetItemMap() map[int32]int32 {
	return t.useItemMap
}

func (t *LingTongLingYuPeiYangTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongLingYuPeiYangTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongLingYuPeiYangTemplate) GetLevel() int32 {
	return t.Level
}

func (t *LingTongLingYuPeiYangTemplate) GetNext() LingTongDevPeiYangTemplate {
	return t.next
}

func (t *LingTongLingYuPeiYangTemplate) GetItemCount() int32 {
	return t.ItemCount
}

func (t *LingTongLingYuPeiYangTemplate) GetItemId() int32 {
	return t.UseItem
}

func (t *LingTongLingYuPeiYangTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingQi
}

func (t *LingTongLingYuPeiYangTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
...
func (t *LingTongLingYuPeiYangTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.NextId != 0 {
		...
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongLingYuPeiYangTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.NextId)
			return template.NewTemplateFieldError("NextId", err)
		}

		t.next = to.(*LingTongLingYuPeiYangTemplate)
	...
	if t.culItemTemplate != nil {
		if t.culItemTemplate.GetItemSubType() != itemtypes.ItemLingTongLingYuSubTypePeiYangDan {
			err = fmt.Errorf("[%d] invalid", t.UseItem)
...
func (t *LingTongLingYuPeiYangTemplate) PatchAfterCheck() {

}
func (t *LingTongLingYuPeiYangTemplate) FileName() string {
	return "tb_lingtong_field_peiyang.json"
}

func init() {
	template.Register((*LingTongLingYuPeiYangTemplate)(nil))
}
