...
//灵身幻化配置
type LingTongShenFaHuanHuaTemplate struct {
	*LingTongShenFaHuanHuaTemplateVO
...
func (t *LingTongShenFaHuanHuaTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongShenFaHuanHuaTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongShenFaHuanHuaTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongShenFaHuanHuaTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongShenFaHuanHuaTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongShenFaHuanHuaTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongShenFaHuanHuaTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongShenFaHuanHuaTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongShenFaHuanHuaTemplate) GetItemMap() map[int32]int32 {
	return t.useItemMap
}

func (t *LingTongShenFaHuanHuaTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongShenFaHuanHuaTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongShenFaHuanHuaTemplate) GetLevel() int32 {
	return t.Level
}

func (t *LingTongShenFaHuanHuaTemplate) GetNext() LingTongDevHuanHuaTemplate {
	return t.next
}

func (t *LingTongShenFaHuanHuaTemplate) GetItemCount() int32 {
	return t.ItemCount
}

func (t *LingTongShenFaHuanHuaTemplate) GetItemId() int32 {
	return t.UseItem
}

func (t *LingTongShenFaHuanHuaTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingShen
}

func (t *LingTongShenFaHuanHuaTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
...
func (t *LingTongShenFaHuanHuaTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.NextId != 0 {
		...
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongShenFaHuanHuaTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.NextId)
			return template.NewTemplateFieldError("NextId", err)
		}

		huanHuaTemplate := to.(*LingTongShenFaHuanHuaTemplate)
	...
	if t.unrealItemTemplate != nil {
		if t.unrealItemTemplate.GetItemSubType() != itemtypes.ItemLingTongShenFaSubTypeUnrealDan {
			err = fmt.Errorf("[%d] invalid", t.UseItem)
...
func (t *LingTongShenFaHuanHuaTemplate) PatchAfterCheck() {

}
func (t *LingTongShenFaHuanHuaTemplate) FileName() string {
	return "tb_lingtong_shenfa_huanhua.json"
}

func init() {
	template.Register((*LingTongShenFaHuanHuaTemplate)(nil))
}
