...
//灵身培养配置
type LingTongShenFaPeiYangTemplate struct {
	*LingTongShenFaPeiYangTemplateVO
...
func (t *LingTongShenFaPeiYangTemplate) TemplateId() int {
	return t.Id
}

func (t *LingTongShenFaPeiYangTemplate) GetNextId() int32 {
	return t.NextId
}

func (t *LingTongShenFaPeiYangTemplate) GetUpdateWfb() int32 {
	return t.UpdateWfb
}

func (t *LingTongShenFaPeiYangTemplate) GetAddMin() int32 {
	return t.AddMin
}

func (t *LingTongShenFaPeiYangTemplate) GetAddMax() int32 {
	return t.AddMax
}

func (t *LingTongShenFaPeiYangTemplate) GetTimesMin() int32 {
	return t.TimesMin
}

func (t *LingTongShenFaPeiYangTemplate) GetTimesMax() int32 {
	return t.TimesMax
}

func (t *LingTongShenFaPeiYangTemplate) GetZhuFuMax() int32 {
	return t.ZhufuMax
}

func (t *LingTongShenFaPeiYangTemplate) GetItemMap() map[int32]int32 {
	return t.useItemMap
}

func (t *LingTongShenFaPeiYangTemplate) GetBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.battlePropertyMap
}

func (t *LingTongShenFaPeiYangTemplate) GetLingTongBattlePropertyMap() map[propertytypes.BattlePropertyType]int64 {
	return t.lingTongBattlePropertyMap
}

func (t *LingTongShenFaPeiYangTemplate) GetLevel() int32 {
	return t.Level
}

func (t *LingTongShenFaPeiYangTemplate) GetNext() LingTongDevPeiYangTemplate {
	return t.next
}

func (t *LingTongShenFaPeiYangTemplate) GetItemCount() int32 {
	return t.ItemCount
}

func (t *LingTongShenFaPeiYangTemplate) GetItemId() int32 {
	return t.UseItem
}

func (t *LingTongShenFaPeiYangTemplate) GetClassType() types.LingTongDevSysType {
	return types.LingTongDevSysTypeLingQi
}

func (t *LingTongShenFaPeiYangTemplate) Patch() (err error) {
	defer func() {
		if err != nil {
...
func (t *LingTongShenFaPeiYangTemplate) Check() (err error) {
	defer func() {
		if err != nil {
			err = template.NewTemplateError(t.FileName(), t.TemplateId(), err)
			return
	...
	if t.NextId != 0 {
		...
		to := template.GetTemplateService().Get(int(t.NextId), (*LingTongShenFaPeiYangTemplate)(nil))
		if to == nil {
			err = fmt.Errorf("[%d] invalid", t.NextId)
			return template.NewTemplateFieldError("NextId", err)
		}

		t.next = to.(*LingTongShenFaPeiYangTemplate)
	...
	if t.culItemTemplate != nil {
		if t.culItemTemplate.GetItemSubType() != itemtypes.ItemLingTongShenFaSubTypePeiYangDan {
			err = fmt.Errorf("[%d] invalid", t.UseItem)
...
func (t *LingTongShenFaPeiYangTemplate) PatchAfterCheck() {

}
func (t *LingTongShenFaPeiYangTemplate) FileName() string {
	return "tb_lingtong_shenfa_peiyang.json"
}

func init() {
	template.Register((*LingTongShenFaPeiYangTemplate)(nil))
}
