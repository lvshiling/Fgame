...
//Boss自定义物品掉落
func battleObjectCustomDrop(target event.EventTarget, data event.EventData) (err error) {
...
func init() {
	gameevent.AddEventListener(sceneeventtypes.EventTypeBattleCustomDrop, event.EventListenerFunc(battleObjectCustomDrop))
}
