...
func exportServer(p_db *model.DBConfigInfo, p_serverid int, p_table string, p_savePath string, p_dumpPath string) error {
...
func init() {
	...
	for _, value := range serverIdTableArray {
		registerExport(value, IMysqlExportFunc(exportServer))
	}
}
