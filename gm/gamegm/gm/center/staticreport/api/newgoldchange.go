...
func handleNewGoldChangeStatic(rw http.ResponseWriter, req *http.Request) {
	...
	rst, err := ss.GetNewGoldChangeStatic(form.StartTime, form.EndTime, centerplatform, serverindex, skdType, playerArray, sdklist, form.GoldType)
