...
type centerServerUpdateChengZhanRequest struct {
	CenterServerId    int `form:"id" json:"id"`
	ChengZhanServerId int `form:"chengZhanServerId" json:"chengZhanServerId"`
}

func handleUpdateCenterServerChengZhan(rw http.ResponseWriter, req *http.Request) {
	form := &centerServerUpdateChengZhanRequest{}
	...
	err = service.UpdateChengZhanFu(form.CenterServerId, form.ChengZhanServerId)
	if err != nil {
