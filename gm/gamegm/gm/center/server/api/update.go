...
type centerServerUpdateRequest struct {
...
func handleUpdateCenterServer(rw http.ResponseWriter, req *http.Request) {
	form := &centerServerUpdateRequest{}
