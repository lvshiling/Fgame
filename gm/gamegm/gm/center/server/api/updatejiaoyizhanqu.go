...
type centerServerUpdateJiaoYiZhanQuRequest struct {
	CenterServerId       int `form:"id" json:"id"`
	JiaoYiZhanQuServerId int `form:"jiaoYiZhanQuServerId" json:"jiaoYiZhanQuServerId"`
}

func handleUpdateCenterServerJiaoYiZhanQu(rw http.ResponseWriter, req *http.Request) {
	form := &centerServerUpdateJiaoYiZhanQuRequest{}
	...
	err = service.UpdateJiaoYiZhanQuFu(form.CenterServerId, form.JiaoYiZhanQuServerId)
	if err != nil {
