...
type centerServerUpdateParentArrayRequest struct {
	CenterServerId []int `form:"id" json:"id"`
	ParentServerId int   `form:"parentServerId" json:"parentServerId"`
}

func handleUpdateCenterServerParentArray(rw http.ResponseWriter, req *http.Request) {
	form := &centerServerUpdateParentArrayRequest{}
	...
	err = service.UpdateParentServerIdArray(form.CenterServerId, form.ParentServerId)
	if err != nil {
