...
type centerServerUpdatePingTaiFuArrayRequest struct {
	CenterServerId    []int `form:"id" json:"id"`
	PingTaiFuServerId int   `form:"pingTaiFuServerId" json:"pingTaiFuServerId"`
}

func handleUpdateCenterServerPingTaiFuArray(rw http.ResponseWriter, req *http.Request) {
	form := &centerServerUpdatePingTaiFuArrayRequest{}
	...
	err = service.UpdatePingTaiFuArray(form.CenterServerId, form.PingTaiFuServerId)
	if err != nil {
