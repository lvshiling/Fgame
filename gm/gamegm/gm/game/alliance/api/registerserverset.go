...
type registerServerSetRequest struct {
	ServerId int32 `json:"serverId"`
	Open     int32 `json:"open"`
}

func handleRegisterServerSet(rw http.ResponseWriter, req *http.Request) {
	form := &registerServerSetRequest{}
	...
	err = remoteService.RegisterServerSet(form.ServerId, form.Open)
	if err != nil {
		log.WithFields(log.Fields{
			"dbid":  form.ServerId,
			"error": err,
