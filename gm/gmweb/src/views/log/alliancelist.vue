<template>
 <div class="app-container">
    <div class="filter-container">
        ...
        <el-input placeholder="仙盟Id" v-model="listQuery.allianceId" style="width: 200px;" class="filter-item"/>
    ...
    <el-table
            ...
            <el-table-column label="仙盟id" width="100px" align="left">
                <template slot-scope="scope">
                    <span>{{ scope.row.allianceId}}</span>
                </template>
            </el-table-column>
            <el-table-column label="仙盟名称" width="100px" align="left">
                <template slot-scope="scope">
            ...
            <el-table-column label="建设" width="100px" align="left">
                <template slot-scope="scope">
                    <span>{{ scope.row.jianShe}}</span>
                </template>
            </el-table-column>
