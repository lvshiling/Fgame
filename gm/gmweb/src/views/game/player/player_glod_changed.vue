    ...
    <div>
        ...
        <el-table
            ...
            <el-table-column label="变化元宝数" width="120px" align="left">
                <template slot-scope="scope">
                  {{ scope.row.changedNum}}
                    <!-- <span v-if="scope.row.changedNum>=0" style="color:green">{{ scope.row.changedNum}}</span>
                    <span v-else style="color:red" >{{ scope.row.changedNum}}</span> -->
                </template>
            </el-table-column>
            <el-table-column label="变化前的元宝数" width="120px" align="left">
                <template slot-scope="scope">
                    <span>{{ scope.row.beforeGold}}</span>
                </template>
            </el-table-column>
            <el-table-column label="当前的元宝数" width="120px" align="left">
                <template slot-scope="scope">
...
export default {
  ...
  data() {
    return {
      ...
      total: 0,
      listQuery: {
        tableName:'player_new_glod_changed',
        pageIndex: 1,
        playerName: "",
        itemId: undefined,
        ordercol: 1,
