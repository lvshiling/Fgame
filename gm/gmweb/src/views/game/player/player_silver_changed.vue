<template>
    <div>
        ...
        <el-table
            ...
            <el-table-column label="变化银两数" width="120px" align="left">
                <template slot-scope="scope">
                    <span>{{ scope.row.changedNum}}</span>
                </template>
            </el-table-column>
            <el-table-column label="变化前的银两数" width="120px" align="left">
                <template slot-scope="scope">
                    <span>{{ scope.row.beforeSilver}}</span>
                </template>
            </el-table-column>
            <el-table-column label="当前的银两数" width="120px" align="left">
                <template slot-scope="scope">
                    <span>{{ scope.row.curSilver}}</span>
                </template>
            </el-table-column>
...
export default {
  ...
  data() {
    return {
      ...
      total: 0,
      listQuery: {
        tableName:'player_silver_changed',
        pageIndex: 1,
        playerName: "",
        itemId: undefined,
        ordercol: 1,
