<template>
    <div>
        ...
        <el-table
            ...
            <el-table-column label="变化元宝数" width="120px" align="left">
                <template slot-scope="scope">
                    <span v-if="scope.row.changedNum>=0"><font color="#43cd80" >{{ scope.row.changedNum}}</font></span>
                    <span v-if="scope.row.changedNum<0"><font color="#DC143C">{{ scope.row.changedNum }}</font></span>
                </template>
            </el-table-column>
            <el-table-column label="变化前的绑元数" width="120px" align="left">
                <template slot-scope="scope">
                    <span>{{ scope.row.beforeBindGold}}</span>
                </template>
            </el-table-column>
            <el-table-column label="当前的绑元数" width="120px" align="left">
                <template slot-scope="scope">
                    <span>{{ scope.row.curBindGold}}</span>
                </template>
            </el-table-column>
...
import { getPlayerLog } from "@/api/playerinfo";
...
export default {
  ...
  data() {
    return {
      ...
      total: 0,
      listQuery: {
        tableName:'player_new_bind_glod_changed',
        pageIndex: 1,
        playerName: "",
        itemId: undefined,
        ordercol: 1,
