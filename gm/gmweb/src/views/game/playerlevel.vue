<template>
    <div class="app-container">
        ...
        <el-table
            ...
            <el-table-column label="等级" align="center" width="180px">
            ...
            <el-table-column label="玩家总占比" width="150px" align="left">
                <template slot-scope="scope">
                    <span>{{ scope.row.rate/100}}%</span>
                </template>
            </el-table-column>
            <el-table-column label="玩家总数" width="150px" align="left">
                <template slot-scope="scope">
...
import { getPlayerLevelStatic,getPlayerLevelStaticExport } from "@/api/player";

export default {
  name: "PlayerLevelStatic",
  directives: {
    waves
  },
  filters: {
  ...
  methods: {
    ...
    getList() {
      ...
      getPlayerLevelStatic(this.listQuery)
        .then(res => {
    ...
    exportList(){
      this.listLoading = true;
      getPlayerLevelStaticExport(this.listQuery)
        .then(res => {
          this.listLoading = false;
          if (!res) {
                return
            ...
            link.href = url
            link.setAttribute('download', '玩家等级统计.xlsx')
