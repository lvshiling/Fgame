...
<div class="app-container">
  <el-tabs type="border-card" v-model="activeName" @tab-click="handleClick">
    <el-tab-pane label="单服设置" name="first">
        <el-form ref="dataForm" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
            ...
            <el-form-item label="是否开启注册">
                <el-select v-model="listQuery.closeFlag" collapse-tags placeholder="是否开启注册" style="width: 180px" class="filter-item" >
    ...
    <el-tab-pane label="单服设置列表" name="second">
      <div class="filter-container">
        ...
        <el-table
            ...
            <el-table-column fixed="left" label="是否开启" align="center" min-width="100px" >
                <template slot-scope="scope">
                    <span>{{ scope.row.open | parseYesOrNo }}</span>
                </template>
            </el-table-column>
            <el-table-column fixed="left" label="创建时间" align="center" min-width="100px" >
                <template slot-scope="scope">
...
export default {
  ...
  methods: {
    ...
    handleServerChange: function(e) {
      ...
      getServerState(postData).then(res => {
        this.listQuery.closeFlag = res.open;
      });
    },
    updateServer() {
      var postData = {
        serverId: this.listQuery.serverId,
        open: this.listQuery.closeFlag
      };
    ...
    getList() {
      ...
      serverSetloglist(this.searchQuery)
        .then(res => {
