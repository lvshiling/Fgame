    ...
    <div class="app-container">
        <div>
            <div class="filter-container">
                ...
                <el-select v-model="listQuery.centerServerId" collapse-tags placeholder="服务器" clearable style="width: 220px" class="filter-item">
                    <el-option v-for="item in serverList" :key="item.serverId" :label="item.serverName" :value="item.serverId"/>
                </el-select>
        ...
        <el-table
            ...
            <el-table-column label="服务器序号" align="center" width="100px">
                <template slot-scope="scope">
                    <span>{{ scope.row.centerServerId }}</span>
                </template>
            </el-table-column>
            <el-table-column label="服务器名称" align="center" min-width="180px">
                <template slot-scope="scope">
                    <span>{{ scope.row.centerServerName }}</span>
                </template>
            </el-table-column>
        ...
        <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
            <el-form ref="dataForm" :model="temp" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
                ...
                <el-form-item label="服务器">
                    <el-select v-model="temp.centerServerArray" :disabled="dialogStatus=='update'" class="filter-item" placeholder="服务器" multiple>
                        <el-option v-for="item in tempServerList" :key="item.serverId" :label="item.serverName" :value="item.serverId"/>
                    </el-select>
                </el-form-item>
...
export default {
  ...
  methods: {
    ...
    updateData(e) {
      updateChatSet(this.temp).then(res => {
        this.dialogFormVisible = false;
        this.showSuccess();
        this.loadData();
      });
    ...
    deleteData(e) {
      deleteChatSet(this.temp).then(res => {
    ...
    loadData() {
      ...
      getChatSetList(this.listQuery).then(res => {
