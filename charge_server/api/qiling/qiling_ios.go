...
func handleQiLingIOS(rw http.ResponseWriter, req *http.Request) {
	query := req.URL.Query()
...
func qiLingSign(key string, userid string, server int32, money string, pay string, order string, timeInt int64) (sign string) {
