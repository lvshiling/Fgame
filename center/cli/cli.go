...
func Start() {
	app := cli.NewApp()
	app.Name = "center server"
	app.Usage = "center [global options] command [command options] [arguments...]."
...
func readConfig(configFile string) (sc *server.CenterServerOptions, err error) {
	log.Infoln("正在读取配置")
...
func start(c *cli.Context) {
	...
	if err != nil {
		log.Fatalln("init game server failed ", err)
	}
